...
describe('validator', () => {
  describe('validator username', () => {
    it('should validate username length', () => {
      expect(validateUsernameLength('dingyuyang')).toBe(true)
    })
  ...
  describe('validator password', () => {
    it('should validate password length', () => {
      expect(validatePasswordLength('dingyuyang')).toBe(true)
    })
  ...
  it('should validate password same', () => {
    expect(validatePasswordSame('dingyuyang', 'dingyuyang')).toBe(true)
  })
})
